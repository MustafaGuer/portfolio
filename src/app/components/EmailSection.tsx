...
const EmailSection = () => {
  return <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
    <div
      ...
      rounded-full h-80 w-80 z-0 absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-y-1/2"></div>
    <div className="z-10">
      ...
      <p className="text-[#ADB7BE] mb-4 max-w-md">
        ...
        want to say hi, I&apos;ll try my best to get back to your!
      </p>
      <div className="socials flex flex-row gap-2">
        <Link href="https://github.com/MustafaGuer" target="_blank"><Image src={GithubIcon} alt="Github Icon" /></Link>
        <Link href="https://www.linkedin.com/in/mustafa-guer/" target="_blank"><Image src={LinkedinIcon}
    ...
    <div>
      <form className="flex flex-col gap-6">
        ...
        <button
          ...
          py-2.5 px-5 rounded-lg w-full">Send Message
        </button>
      </form>
    </div>
  </section>
